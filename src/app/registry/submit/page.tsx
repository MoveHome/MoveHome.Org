...
export default function SubmitPage() {
  ...
  return (
    <main className="max-w-2xl mx-auto px-4 py-10">
      ...
      {ok ? (
        <div className="mt-6 rounded border border-[var(--accent)] bg-[var(--tint-lightest)] p-4">
          <p className="font-medium text-[var(--accent-hover)]">Listed ✓</p>
      ...
      {err ? (
        <div className="mt-6 rounded border border-red-400 bg-[var(--bg-elev)] p-4">
          <p className="font-medium text-red-600">{err.title || 'Could not register'}</p>
